...
const cases: Case[] = [
  ...
  { label: 'facebook partial prefix', text: 'escribeme en faceboo', context: 'chat', expectBlocked: true, expectCategory: 'social' },
  { label: 'discord partial prefix', text: 'mi discor es cool', context: 'chat', expectBlocked: true, expectCategory: 'social' },
  { label: 'telegram partial prefix', text: 'buscame en telegra', context: 'chat', expectBlocked: true, expectCategory: 'social' },
  { label: 'tiktok partial prefix', text: 'estoy en tiktoc', context: 'chat', expectBlocked: true, expectCategory: 'social' },
